# structural capacity under fire
# extension of 4.0 (ambient)
# compared with ambient 4.0; simialr results. difference due to slight expansion at ambient temperature
                ...
                for k in range(0, size_strain + 1):
                    ...
                    if strain_limit[k] > 0:
                        ...
                        for i in range(1, Ny + 1):
                            ...
                            buckling_s = math.pi ** 2 * (mod_s_c * N_com_bar + mod_s_t * N_ten_bar) * mom_ini_s / (length * BC) ** 2
